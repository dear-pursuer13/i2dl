...
class ImageFolderDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.transform == None:
            image_array = ImageFolderDataset.load_image_as_numpy(self.images[index])
            data_dict = dict(image = image_array, label = self.labels[index])
        else:
            image_array = self.transform(ImageFolderDataset.load_image_as_numpy(self.images[index]))
            data_dict = dict(image = image_array, label = self.labels[index])
